 ...
 * @author Lenovo
 */
public class moduloQuimicos extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorGlobal
     */
    public moduloQuimicos() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Modulo Quimicos");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Q u i m i c o s");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(moduloQuimicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new moduloQuimicos().setVisible(true);
            }
        });
    }
