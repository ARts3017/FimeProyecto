 ...
 * @author Lenovo
 */
public class ModuloDoctores extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorGlobal
     */
    public ModuloDoctores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("D o c t o r e s");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        tablaLaboratorio L = new tablaLaboratorio();
        L.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModuloDoctores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModuloDoctores().setVisible(true);
            }
        });
    }
